        ...
        Timer().schedule(
            ...
            try {
                ...
                Grabber(mainProps.seleniumUrl, mainProps.netSchoolUrl,
                    ...
                    scoreToSend.reversed().forEach { dairyItem ->
                        dairyItem.scores.forEach {score ->
                            val message = "${dateFormat.format(dairyItem.date)} ${dairyItem.discipline}\n*${score.score}* ${score.scoreReason}"
